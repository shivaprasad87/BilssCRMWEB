...
<body>
                ...
                <?php } ?>
                          ...
                          <img src="<?php echo base_url()?>assets/img/logo.jpg"style="width: 35%;padding: 11px;margin-top: -30px;">
													    <div class="login">
