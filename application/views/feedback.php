...
<body>
<div class="content">
	<h1><img src="<?=base_url('assets/img/logo.jpg');?>"></h1>
	<h1>Feedback Form</h1>
...
<?php endif; ?>
	...
	<p class="footer">&copy; <?=date('Y');?> Blisss Realtys. All Rights Reserved | Developed by <a href="http:s//secondsdigital.com"> seconds digital solutions</a></p>
</div>
